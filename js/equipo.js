...
function Equipo(juego, cpu){
    ...
    this.inicializa_equipo = function(){
    	...
    	if (this.is_CPU){
        	this.jugadores.push(new Player(juego, 2100, 220, true));
	        this.jugadores.push(new Player(juego, 2100, 720, true));
	        this.jugadores.push(new Player(juego, 1800, 220, true));
	        this.jugadores.push(new Player(juego, 1800, 720, true));
	        this.jugadores.push(new Player(juego, 1500, 220, true));
	        this.jugadores.push(new Player(juego, 1500, 720, true));
    	}
    	else{
    		this.jugadores.push(new Player(juego, 300, 220));
	        this.jugadores.push(new Player(juego, 300, 720));
	        this.jugadores.push(new Player(juego, 600, 220));
	        this.jugadores.push(new Player(juego, 600, 720));
	        this.jugadores.push(new Player(juego, 900, 220));
